...
//
//	# Register a user
//	curl -X POST http://localhost:3000/api/v1/auth/register -d '{"name":"Alice","email":"alice@example.com","password":"secret123"}'
//
//	# Login (returns JWT token)
//	curl -X POST http://localhost:3000/api/v1/auth/login -d '{"email":"alice@example.com","password":"secret123"}'
//
